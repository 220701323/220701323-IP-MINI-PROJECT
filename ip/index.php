      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-7">
            ...
            <button class="custom-button "><a href="https://www.youtube.com/watch?v=4-h9zTfdEY4" class="btn" target="_blank">
            Watch Video
        </a></button>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-7 order-2 order-md-1">
            ...
            <button class="custom-button"><a href="payment.php" class="menu-item-link">Order Now</a></button>
            <div class="mt-3">
              <img
